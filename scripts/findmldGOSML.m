function [mixeddp] = findmld(temp,sal,pres)

%%% Pierre Damien : adapted from Holte and Talley 2009 paper. 

% This subroutine calculates the mixed layer depth (MLD) of the input profile.  
% It is called by get_mld.m.

 mldindex=1 ; yesplot=0 ;
...
%        plot(sal(gdmld(mldindex)),pres(gdmld(mldindex)),'>','MarkerFaceColor','r','MarkerEdgeColor','k','MarkerSize',16);                 %        plot(sal(upperdsmaxi),upperdsmax(mldindex),'o','MarkerFaceColor',[1 .5 0],'MarkerEdgeColor','k','MarkerSize',12)
